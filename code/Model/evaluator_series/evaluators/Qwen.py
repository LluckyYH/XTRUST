...
Qwen_path = r'/home/liyahan/models/Qwen-chat-7b'
...
class Qwen_Evaluator(Evaluator):
    def __init__(self, choices, k, model_name, t, s, pt,es, l, device):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(Qwen_path, trust_remote_code=True, mirror="tuna",resume_download = True).half().to(device)
